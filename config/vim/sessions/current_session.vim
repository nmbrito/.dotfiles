...
map Oj *
map Oo :
nnoremap  <F11> :source $VIMSESSIONS/current_session.vim
...
nnoremap <F11> :mksession! $VIMSESSIONS/current_session.vim
...
nnoremap <C-J> j
nnoremap <C-H> h
nnoremap <silent> <F12> :sp $DOTDIR/RTM.md
nnoremap <S-F11> :mksession! $VIMSESSIONS/current_session.vim
...
set ruler
set runtimepath=~/.vim,~/.vim/pack/tpope/start/surround,~/.vim/pack/tpope/start/fugitive,~/.vim/pack/tpope/start/commentary,~/.vim/pack/preservim/start/vim-indent-guides,~/.vim/pack/ntpeters/start/vim-better-whitespace,~/.vim/pack/mbbill/start/undotree,~/.vim/pack/machakann/start/vim-highlightedyank,~/.vim/pack/junegunn/start/rainbow_parentheses.vim,~/.vim/pack/junegunn/start/limelight.vim,~/.vim/pack/junegunn/start/goyo.vim,~/.vim/pack/junegunn/start/fzf.vim,~/.vim/pack/junegunn/start/fzf,~/.vim/pack/dist/start/vim-airline-themes,~/.vim/pack/dist/start/vim-airline,/usr/share/vim/site,/usr/share/vim/vim90,/usr/share/vim/site/after,~/.vim/after
set shiftwidth=4
set showcmd
set showmatch
set noshowmode
...
badd +163 .vimrc
badd +32 .zshrc
badd +50 .config/tmux/tmux.conf
badd +1 .config/tmux/tmux_statusline.conf
badd +3 INSTALL/cli-install.sh
badd +23 INSTALL/cli-libfunction.sh
badd +32 INSTALL/cli-software.sh
badd +17 RTM.md
badd +54 .config/zsh/aliasrc.zsh
badd +2 .config/zsh/pluginsrc.zsh
badd +1 INSTALL/cli-installservers.sh
argglobal
%argdel
$argadd .zshrc
$argadd .vimrc
$argadd .config/tmux/tmux.conf
$argadd .config/tmux/tmux_statusline.conf
$argadd INSTALL/cli-install.sh
$argadd INSTALL/cli-libfunction.sh
$argadd INSTALL/cli-software.sh
edit INSTALL/cli-installservers.sh
argglobal
if bufexists(fnamemodify("INSTALL/cli-installservers.sh", ":p")) | buffer INSTALL/cli-installservers.sh | else | edit INSTALL/cli-installservers.sh | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
